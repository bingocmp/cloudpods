...
type IRegionDriver interface {
	...
	RequestSyncSecurityGroup(ctx context.Context, userCred mcclient.TokenCredential, managerId, vpcId string, vpc *SVpc, secgroup *SSecurityGroup, removeProjectId, service string) (string, error)
